package com.rico.springbatch.boot.config;
...
import com.rico.springbatch.boot.model.RecordSO;
import com.rico.springbatch.boot.model.WriterSO;
import com.rico.springbatch.boot.processor.RecordProcessor;
...
public class BatchConfiguration {
	...
	@Bean
	public Step step1(StepBuilderFactory stepBuilderFactory, ItemReader<RecordSO> reader, ItemWriter<WriterSO> writer,
			ItemProcessor<RecordSO, WriterSO> processor) {
